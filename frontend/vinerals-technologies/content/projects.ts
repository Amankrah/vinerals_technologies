...
export const projects: Project[] = [
  {
    ...
    description:
      'Decision platform that scores meals across nutrition and planetary impact — Canada’s Nutrient File, Health Star Rating, Food Compass, HEFI, HENI, and ReCiPe 2016 LCA in one place.',
    challenge:
    ...
    solution:
      'Built at McGill’s SASEL Lab as a research-grade platform spanning 5,000+ CNF foods, 150+ nutrition metrics, and 18 environmental impact categories — with Canadian regionalization and CAD monetization.',
    ...
    features: [
      ...
      'Custom meal planning with instant multi-dimension scores',
    ],
    featured: true,
  },
  {
  ...
  },
  {
    ...
    description:
      'Food Systems Financing Intelligence for Rwanda’s Ministry of Agriculture — 37 PSTA 5–aligned indicators showing where public and partner funds relieve stress across the food system.',
    challenge:
    ...
    solution:
      'A decision-support platform computing the Food System Financing Stress Index across eight components — crop, animal systems, post-harvest, markets, nutrition, finance, research, and environment — with scenario stress-testing.',
  ...
  },
  {
    ...
    description:
      'Offline-first survey and analytics platform for food-system research — design studies, collect on tablets without connectivity, sync cleanly, then run statistics in one tool.',
    challenge:
  ...
  },
  {
    ...
    description:
      'EU food-fraud vulnerability intelligence — 43 quantitative formulas scoring trade corridors from UN Comtrade, RASFF hazards, FAOSTAT, and Eurostat.',
    challenge:
      'Food fraud hides in trade networks and hazard patterns spreadsheets can’t surface. Regulators needed defensible, reproducible risk scores.',
    solution:
      'A Rust computational core with PyO3 bindings scoring 638 corridors across 60 nodes — commodity dependency, hazard intensity, trade anomalies, and network exposure — with live parameter reconfiguration.',
  ...
  },
  {
    ...
    description:
      'Life Cycle Assessment for African agri-food value chains — farm and processor footprints in minutes, aligned with ISO 14040/14044 and export requirements like EU CBAM and EUDR.',
    challenge:
    ...
    features: [
      'Farm assessments in 15–20 minutes',
      'Processing assessments in 10–15 minutes',
